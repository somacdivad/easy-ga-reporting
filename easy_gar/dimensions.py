...
class Dimensions:
    ...
    def days_since_last_session(self):
        return Dimension(name="ga:daysSinceLastSession", alias="Days Since Last Session")
    ...
    def has_social_source_referral(self):
        return Dimension(name="ga:hasSocialSourceReferral", alias="Social Source Referral")
    ...
    def ad_distribution_network(self):
        return Dimension(name="ga:adDistributionNetwork", alias="Ad Distribution Network")
    ...
    def goal_completion_location(self):
        return Dimension(name="ga:goalCompletionLocation", alias="Goal Completion Location")
    ...
    def mobile_marketing_name(self):
        return Dimension(name="ga:mobileDeviceMarketingName", alias="Mobile Device Marketing Name")
    ...
    def source_property_display_name(self):
        return Dimension(name="ga:sourcePropertyDisplayName", alias="Source Property Display Name")
    
    @property
    def source_property_tracking_id(self):
        return Dimension(name="ga:sourcePropertyTrackingId", alias="Source Property Tracking ID")
    ...
    def interest_affinity_category(self):
        return Dimension(name="ga:interestAffinityCategory", alias="Affinity Category (reach)")
